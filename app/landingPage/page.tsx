            ...
            <div className='w-full flex flex-1'>
                <div className='md:flex mx-auto w-full md:w-11/12 lg:w-11/12 xl:w-10/12 lg:gap-10  gap-5 py-[50px]'>
                    <div className='flex flex-col w-full lg:w-1/2 gap-10 pb-10 md:pb-0'>
                        <div className='mx-auto min-h-[270px] overflow-hidden w-4/5 md:w-full aspect-video rounded-[14px]'>
                            <VideoCard />
                        </div>
                        <div className='mx-auto min-h-[270px] w-4/5 md:w-full aspect-video rounded-[14px] p-7 overflow-hidden bg-white'>
                            <TestemonyCard />
                        </div>
                    </div>
                    <div className='flex flex-col w-full lg:w-1/2 gap-10'>
                        <label htmlFor="formFile" className='flex min-h-[270px] flex-col mx-auto w-4/5 md:w-full  place-items-center aspect-video place-content-center
                        ...
                        <div className='flex min-h-[270px] place-content-center
